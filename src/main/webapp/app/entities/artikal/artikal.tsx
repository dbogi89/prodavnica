...
import { getEntities, reset } from './artikal.reducer';
...
export type IArtikalState = IPaginationBaseState;

export class Artikal extends React.Component<IArtikalProps, IArtikalState> {
  state: IArtikalState = {
              ...
              <Table responsive>
                <thead>
                  <tr>
                    ...
                    <th className="hand" onClick={this.sort('imeArtikla')}>
                      Ime Artikla <FontAwesomeIcon icon="sort" />
                    </th>
                    <th className="hand" onClick={this.sort('barKod')}>
                      Bar Kod <FontAwesomeIcon icon="sort" />
                    </th>
                    <th className="hand" onClick={this.sort('cena')}>
                      Cena <FontAwesomeIcon icon="sort" />
                    </th>
                    <th />
                  </tr>
                </thead>
...
const mapStateToProps = ({ artikal }: IRootState) => ({
  ...
  totalItems: artikal.totalItems,
  links: artikal.links,
  entity: artikal.entity,
  updateSuccess: artikal.updateSuccess
});
